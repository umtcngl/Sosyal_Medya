...
<div class="container">
    ...
    <div class="row">
        <div class="col-12"> <!-- Tek sütun olarak ayarla -->
            @foreach ($gonderiler as $gonderi)
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center p-1">
                                        <div>
                                            @if ($gonderi->kullanici)
                                                ...
                                                <h3 class="card-title">
                                                    <a class="btn" href="{{ route('profil.display', ['id' => $gonderi->kullanici->id]) }}" style="text-decoration: none; color: inherit;">
                                    ...
                                    <img src="{{ asset($gonderi->resim_yolu) }}" class="card-img-top img-fluid m-4" alt="Gönderi Resmi" style="max-width: 600px;">
                                    @endif
                                    ...
                                    <!-- Paylaşılma Tarihi -->
                                    <p class="card-text small d-flex justify-content-between align-items-center ps-3">
